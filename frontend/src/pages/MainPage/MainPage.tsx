...
const MainPage = () => {
    ...
    return <Flex vertical align={"center"} gap={20} className={"h-screen w-full"}>
        ...
        <MenuItem title={"Электронный журнал авторского надзора"}/>
        <MenuItem title={"Реестр ИТД"}/>
        <MenuItem title={"Реестр технических решений"}/>
        <MenuItem title={"Список лиц на объекте"}/>
        <MenuItem title={"Консультации на объекте"}/>
    </Flex>
};
